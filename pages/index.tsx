  ...
  return (
    <div>
      ...
      <div className="py-16 px-4 flex flex-col items-center">
        ...
        <a
          href="https://github.com/alvr-org/alvr#requirements"
          className="mt-16"
        >
        ...
        <div className="p-4 xl:px-0 flex flex-col space-y-8 justify-between items-center md:p-8 lg:items-stretch lg:space-x-8 lg:space-y-0 lg:flex-row max-w-screen-xl">
          ...
          >
            <p className="opacity-90 text-lg">
              By streaming games straight from your PC to your headset, ALVR
              lets you play without a tether. No more tangling and tripping!
            </p>
          </Card>
          <Card
          ...
          >
            <p className="opacity-90 text-lg">
              ...
              already have VR games in your Steam library, no need to purchase
              them again!
            </p>
          </Card>
        </div>
