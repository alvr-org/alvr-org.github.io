...
export const Banner = ({ children, className, type }: BannerProps) => {
    return (
        <div
            className={cx(
                `text-center py-2 p-5 bg-gradient-to-br ${
                    type != null ? types[type] || types.info : types.info
                } rounded-2xl text-white font-medium text-lg shadow-lg md:mx-20 lg:mx-36`,
                className,
            )}
        >
            {children}
